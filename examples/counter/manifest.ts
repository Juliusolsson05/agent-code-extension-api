...
export default {
  ...
  activationEvents: ['onCommand:managed.increment', 'onCommand:managed.read', 'onCommand:managed.write', 'onView:managed.main'],
  permissions: ['fs.read', 'fs.write'],
  contributes: {
    commands: ['increment', 'snapshot', 'arm', 'read', 'write'].map(id => ({ id: `managed.${id}`, title: id })),
